## Flux-Kontext extension ##
## Z-Image-Turbo Control extension ##
## ersatzForge webUI ##
...
<details>
<summary>Z-Image-Turbo Control</summary>
download model from: https://huggingface.co/alibaba-pai/Z-Image-Turbo-Fun-Controlnet-Union

save to: `models/other_module` (or put with text encoders, or VAEs)

One input image, preprocessed. Canny, Depth, HED, MLSD, Pose.
</details>
