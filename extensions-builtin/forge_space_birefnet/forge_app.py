...
def video_process(video, bg_colour):
    ...
    processed_video = moviepy.ImageSequenceClip(processed_frames, fps=fps)

    # Add the original audio back to the processed video
    processed_video.audio = audio
...
with gr.Blocks(analytics_enabled=False, css=css, title="Background Removal") as demo:
