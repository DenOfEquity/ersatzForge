...
options_templates.update(options_section(('sd', "Stable Diffusion", "sd"), {
    ...
    "use_ELLA": OptionInfo("CLIP", "Use ELLA for SD1.5", gr.Radio, {"choices": ["CLIP (normal)", "ELLA only", "CLIP + ELLA"]}, infotext="ELLA text encoder and ELLA model will be automatically downloaded.").info("https://github.com/TencentQQGYLab/ELLA"),
}))
