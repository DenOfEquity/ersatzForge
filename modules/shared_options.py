...
options_templates.update(options_section(("sd", "Stable Diffusion", "sd"), {
    ...
    "use_negPiP": OptionInfo("Disabled", "enable negPiP: negative Prompt in Prompt", gr.Radio, {"choices": ["Disabled", "Enabled", "Enabled (+)"]}, infotext="negPiP").info("particularly useful for models that use CFG=1. Currently supported for Anima, Flux.2 Klein, Krea2, Qwen 2.1, Z-Image. Effectiveness varies. 'Enabled' handles negative weights; 'Enabled (+)' handles all emphasis."),
