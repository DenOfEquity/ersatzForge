...
class ScriptSampler(scripts.ScriptBuiltinUI):
    ...
    def ui(self, is_img2img):
        ...
        with FormRow(elem_id=f"sampler_selection_{self.tabname}"):
            ...
            self.scheduler = gr.Dropdown(label="Schedule type", elem_id=f"{self.tabname}_scheduler", choices=scheduler_names, value="Simple")
        ...
        shared.options_templates.update(shared.options_section(('ui_sd', "UI defaults 'sd'", "ui"), {
            ...
            "sd_t2i_scheduler":   shared.OptionInfo("Simple",       "txt2img scheduler",    gr.Dropdown, {"choices": scheduler_names}),
            "sd_i2i_sampler":     shared.OptionInfo("Euler a",      "img2img sampler",      gr.Dropdown, {"choices": sampler_names}),
            "sd_i2i_scheduler":   shared.OptionInfo("Simple",       "img2img scheduler",    gr.Dropdown, {"choices": scheduler_names}),
        }))
